...
import { Input, Button, Stack, Box, FormControl, FormLabel, Image } from '@chakra-ui/react'; // form imports
  ...
  return (
    <Stack flexDir="column" mb="2" justifyContent="center" alignItems="center">
      <Box width="100%" maxWidth="100%">
        <Box boxShadow="md" borderRadius="md" as="form" onSubmit={formik.handleSubmit}>
          <Stack spacing={4} p="1rem" boxShadow="md">
            ...
            {/* logo */}
            <FormControl>
              {formik.touched.logo && formik.errors.logo ? <InputErrorAlert text={formik.errors.logo} /> : null}
