import { Box, Button, FormControl, FormLabel, Input, Select, Stack, Text, useToast } from '@chakra-ui/react';
    ...
    <Stack flexDir="column" mb="2" justifyContent="center" alignItems="center">
      ...
      >
        <Stack spacing={4}>
          {/* Name input */}
          <FormControl>
            {formik.touched.name && formik.errors.name ? <InputErrorAlert text={formik.errors.name} /> : null}
          ...
          {/* Email input  */}
          <FormControl mt={2}>
            {formik.touched.email && formik.errors.email ? <InputErrorAlert text={formik.errors.email} /> : null}
          ...
          {/* Role input */}
          <FormControl>
            {formik.touched.role && formik.errors.role ? <InputErrorAlert text={formik.errors.role} /> : null}
          ...
          <FormControl>
            ...
            <Stack direction={['column', 'row']} align={{ base: 'start', sm: 'center' }}>
              <Input
                ref={profilePhotoRef}
                display="none"
                type="file"
          ...
          {/* Submit button */}
          <Box>
            <Button type="submit" variant="solid" colorScheme="teal" mt={6} isFullWidth>
              Login
            </Button>
          </Box>
        </Stack>
